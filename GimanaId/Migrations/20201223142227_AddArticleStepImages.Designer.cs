...
namespace GimanaIdApi.Migrations
{
    ...
    [Migration("20201223142227_AddArticleStepImages")]
    partial class AddArticleStepImages
    {
            ...
            modelBuilder.Entity("GimanaIdApi.Entities.Entities.ArticleStep", b =>
                {
                    ...
                    b.OwnsOne("GimanaIdApi.Entities.ValueObjects.Image", "Image", b1 =>
                        {
                            b1.Property<Guid>("ArticleStepId")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("ArticleStepId");

                            b1.ToTable("ArticleStep");

                            b1.WithOwner()
                                .HasForeignKey("ArticleStepId");
                        });
